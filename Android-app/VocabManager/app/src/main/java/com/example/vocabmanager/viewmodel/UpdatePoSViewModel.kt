...
class UpdatePoSViewModel(application: Application) : AndroidViewModel(application) {
    companion object {
        const val TAG = "UpdatePoSViewModel"
    }
    ...
    fun updatePoS(posId: Int?, posName: String) {
        val poS = PoS(
            vocabTypeId = posId,
        ...
        val d = repository.updatePoS(poS)
