...
class AddVocabViewModel(application: Application) :
    AndroidViewModel(application) {
    companion object {
        const val TAG = "AddVocabViewModel"
    }
    ...
    fun saveVocab(vocabEn: String, vocabIpa: String, vocabDescription: String,
        ...
        val d = repository.addVocab(vocab)
