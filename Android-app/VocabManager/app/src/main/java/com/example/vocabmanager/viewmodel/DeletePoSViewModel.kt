...
class DeletePoSViewModel(application: Application) : AndroidViewModel(application) {
    companion object {
        const val TAG = "DeletePoSViewModel"
    }
    ...
    fun deletePoS(id: Int) {
        Log.d(TAG, "deletePoS: ")
        val d = repository.deletePoS(id)
